...
describe("CRM persistence mappings", () => {
  ...
  it("round-trips customers", () => {
    const restored = CustomerMapper.fromRow(CustomerMapper.toRow(customer) as never);
  ...
  it("round-trips contacts", () => {
    ...
    const restored = ContactMapper.fromRow(ContactMapper.toRow(contact) as never);
  ...
  it("round-trips opportunities", () => {
    ...
    const restored = OpportunityMapper.fromRow(OpportunityMapper.toRow(opportunity) as never);
  ...
  it("round-trips immutable interactions", () => {
    ...
    const restored = InteractionMapper.fromRow(InteractionMapper.toRow(interaction) as never);
