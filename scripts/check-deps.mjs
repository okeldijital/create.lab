 ...
 * BUILD-009 adds Infrastructure → Quotation repository adapters.
 */
...
const ALLOWED_DEPS = {
  ...
  infrastructure: new Set(["application", "organization", "crm", "workforce", "services", "quotation", "core", "config"]),
