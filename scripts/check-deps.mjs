 ...
 * BUILD-014 adds Infrastructure → Projects repository adapters.
 */
...
const ALLOWED_DEPS = {
  ...
  infrastructure: new Set(["application", "organization", "crm", "workforce", "capacity", "scheduling", "projects", "services", "quotation", "contracts", "knowledge", "core", "config"]),
