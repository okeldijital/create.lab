 ...
 * BUILD-013 adds Infrastructure → Scheduling repository adapters.
 */
...
const ALLOWED_DEPS = {
  ...
  infrastructure: new Set(["application", "organization", "crm", "workforce", "capacity", "scheduling", "services", "quotation", "contracts", "knowledge", "core", "config"]),
